    ...
    public function run(): void
    {
        $menus = [
            ...
            [
                'name' => 'Surat Masuk',
                'url' => 'surat.index',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>',
                'order' => 2,
                'is_active' => true,
            ],
            [
                ...
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" /></svg>',
                'order' => 3,
                'is_active' => true,
            ],
            [
                ...
                'url' => 'menu.index',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" /></svg>',
                'order' => 4,
                'is_active' => true,
            ],
            [
        ...
        foreach ($menus as $menu) {
            Menu::updateOrCreate(['url' => $menu['url']], $menu);
        }
    }
}
