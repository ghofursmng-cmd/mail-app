...
<div class="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight text-emerald-600">Edit Surat Keluar</h1>
            <p class="text-slate-500 mt-1 font-medium italic">Perbarui informasi detail surat keluar.</p>
        </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
        <form action="{{ route('surat-keluar.update', $suratKeluar->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_surat" id="nomor_surat" value="{{ old('nomor_surat', $suratKeluar->nomor_surat) }}" required
                            class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all font-medium @error('nomor_surat') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_surat" id="tanggal_surat" value="{{ old('tanggal_surat', $suratKeluar->tanggal_surat) }}" required
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="tujuan_surat" id="tujuan_surat" value="{{ old('tujuan_surat', $suratKeluar->tujuan_surat) }}" required
                            class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all font-medium @error('tujuan_surat') border-red-500 @enderror">
            ...
            <div class="space-y-6 pt-4 border-t border-slate-50">
                <div>
                    ...
                    <textarea name="perihal" id="perihal" rows="5" required
                        class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all font-medium @error('perihal') border-red-500 @enderror">{{ old('perihal', $suratKeluar->perihal) }}</textarea>
