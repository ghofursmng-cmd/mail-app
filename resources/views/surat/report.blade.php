...
<body onload="if(window.location.search.indexOf('print') > -1) window.print()">
    ...
    <div class="title">
        <h3>REKAPITULASI ARSIP SURAT MASUK</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">#{{ $surat->nomor_agenda }}</td>
                <td style="text-align: center;">{{ \Carbon\Carbon::parse($surat->tanggal_terima)->format('d/m/Y') }}</td>
