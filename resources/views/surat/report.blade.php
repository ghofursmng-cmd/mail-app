...
<head>
    ...
    <title>Laporan Surat Masuk - {{ date('d M Y') }}</title>
    <style>
...
<body onload="if(window.location.search.indexOf('print') > -1) window.print()">
    <div class="header">
        <h1>Laporan Arsip Surat Masuk</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-weight: bold;">{{ $surat->asal_surat }}</td>
                <td>{{ $surat->perihal }}</td>
            </tr>
            @endforeach
        </tbody>
    ...
    <div class="no-print" style="margin-top: 20px; text-align: center;">
        <button onclick="window.print()" style="padding: 10px 20px; background: #4f46e5; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold;">Klik untuk Cetak</button>
