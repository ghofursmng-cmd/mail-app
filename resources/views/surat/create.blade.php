...
<div class="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight">Tambah Surat Masuk</h1>
            <p class="text-slate-500 mt-1 font-medium italic">Masukkan informasi detail surat masuk baru.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_agenda" id="nomor_agenda" value="{{ old('nomor_agenda') }}" required
                            class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:text-slate-300 font-medium @error('nomor_agenda') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_terima" id="tanggal_terima" value="{{ old('tanggal_terima') }}" required
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_surat" id="nomor_surat" value="{{ old('nomor_surat') }}" required
                            class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:text-slate-300 font-medium @error('nomor_surat') border-red-500 @enderror">
            ...
            <div class="space-y-6 pt-4 border-t border-slate-50">
                <div>
                    ...
                    <input type="text" name="asal_surat" id="asal_surat" value="{{ old('asal_surat') }}" required
                        class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:text-slate-300 font-medium @error('asal_surat') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <textarea name="perihal" id="perihal" rows="4" required
                        class="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all placeholder:text-slate-300 font-medium @error('perihal') border-red-500 @enderror">{{ old('perihal') }}</textarea>
