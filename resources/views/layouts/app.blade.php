    ...
    <aside id="sidebar" class="sidebar fixed top-0 left-0 bottom-0 w-[280px] bg-white border-r border-slate-200 z-50 flex flex-col p-6">
        <div class="flex items-center gap-3 mb-10 px-2">
            ...
            <div class="overflow-hidden">
                <span class="text-lg font-bold tracking-tight text-slate-800 block leading-tight">DISDIKPORA JEPARA</span>
                <span class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest leading-none">Bidang PTK</span>
            </div>
        </div>
